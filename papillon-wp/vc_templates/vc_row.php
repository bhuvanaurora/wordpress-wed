...
switch($row_type){
	...
	case 1:
		$output .= '</div></div></section><section '.$row_id_s.' class="'.$css_class.' full-row">';
		$output .= wpb_js_remove_wpautop($content);
		$output .= '</section><section class="container"><div class="row"><div class="row-wrapper-x">'.$this->endBlockComment('row');
		break;
	case 2: 
