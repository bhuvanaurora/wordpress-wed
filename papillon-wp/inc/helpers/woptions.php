...
if (!class_exists('webnus_options')) {
	...
	class webnus_options {
		...
		function webnus_enable_livesearch() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_enable_livesearch']) ? $thm_options['webnus_enable_livesearch'] : 1;
		...
		function webnus_header_menu_type() {
			...
			return isset($thm_options['webnus_header_menu_type']) ? $thm_options['webnus_header_menu_type'] : 2;
		}
		...
		function webnus_news_ticker() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_news_ticker']) ? $thm_options['webnus_news_ticker'] : '1';
		}

		function webnus_nt_show() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_show']) ? $thm_options['webnus_nt_show'] : '0';
		}
		function webnus_nt_title() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_title']) ? $thm_options['webnus_nt_title'] : 'Latest Posts';
		}		
		function webnus_nt_cat() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_cat']) ? $thm_options['webnus_nt_cat'] : '';
		}	
		function webnus_nt_count() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_count']) ? $thm_options['webnus_nt_count'] : '5';
		}		
		function webnus_nt_effect() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_effect']) ? $thm_options['webnus_nt_effect'] : 'reveal';
		}		
		function webnus_nt_speed() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_speed']) ? $thm_options['webnus_nt_speed'] : '1';
		}
		function webnus_nt_pause() {
			$thm_options = get_option('webnus_options');
			return isset($thm_options['webnus_nt_pause']) ? $thm_options['webnus_nt_pause'] : '2';
		}
		...
		function webnus_blog_social_share() {
			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_blog_social_share']) ? $thm_options['webnus_blog_social_share'] : 1;
		}
		...
		function webnus_footer_instagram_username() {
		
			$thm_options = get_option('webnus_options');
			
			return isset($thm_options['webnus_footer_instagram_username']) ? $thm_options['webnus_footer_instagram_username'] : null;
		}
		
		function webnus_footer_instagram_access() {
		
			$thm_options = get_option('webnus_options');
			
			return isset($thm_options['webnus_footer_instagram_access']) ? $thm_options['webnus_footer_instagram_access'] : null;
		}
		
		function webnus_footer_instagram_bar() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_footer_instagram_bar']) ? $thm_options['webnus_footer_instagram_bar'] : null;
		}
		function webnus_footer_social_bar() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_footer_social_bar']) ? $thm_options['webnus_footer_social_bar'] : null;

		}
		function webnus_footer_feedburner_id() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_footer_feedburner_id']) ? $thm_options['webnus_footer_feedburner_id'] : null;

		}
		function webnus_footer_subscribe_bar() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_footer_subscribe_bar']) ? $thm_options['webnus_footer_subscribe_bar'] : null;

		}
		
		function webnus_footer_subscribe_text() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_footer_subscribe_text']) ? $thm_options['webnus_footer_subscribe_text'] : null;
		...
		function webnus_topnav_font_wieght() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_topnav_font_wieght']) ? $thm_options['webnus_topnav_font_wieght'] : null;

		}		
		function webnus_topnav_font_color() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_topnav_font_color']) ? $thm_options['webnus_topnav_font_color'] : null;
		...
		function webnus_h1_font_wieght() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_h1_font_wieght']) ? $thm_options['webnus_h1_font_wieght'] : null;
		...
		function webnus_h2_font_wieght() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_h2_font_wieght']) ? $thm_options['webnus_h2_font_wieght'] : null;
		...
		function webnus_h3_font_wieght() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_h3_font_wieght']) ? $thm_options['webnus_h3_font_wieght'] : null;
		...
		function webnus_h4_font_wieght() {

			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_h4_font_wieght']) ? $thm_options['webnus_h4_font_wieght'] : null;
