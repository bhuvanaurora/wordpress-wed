...
?>
	 <div class="col-md-6 col-lg-4"><article class="latest-b2">
	  ...
	  <h5 class="latest-b2-date"><?php the_author_posts_link(); ?> / <?php echo get_the_date('M d, Y');?></h5>
	  </div></article></div>
<?php
	endwhile;
	}elseif ($type=='six'){
...
?>
	<div class="col-md-3 col-sm-6"><article class="latest-b">
	  <figure class="latest-img"><?php get_the_image( array( 'meta_key' => array( 'thumbnail', 'thumbnail' ), 'size' => 'home_lfb' ) );   ?></figure>
		...
		<p class="latest-author"><strong>by</strong> <?php the_author_posts_link(); ?> <strong>in</strong> <?php the_category(', '); ?></p>  
		</div> 
      </article></div>
<?php
	endwhile;
