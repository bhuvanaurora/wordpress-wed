 ...
 */
(function() {
    tinymce.create('tinymce.plugins.subtitle3', {
        init: function(ed, url) {
            ed.addButton('subtitle3', {
                title: 'Subtitle',
                image: url + '/title-ico-3.png',
                onclick: function() {

                    tinyMCE.activeEditor.selection.setContent('[subtitle3] Title [/subtitle3]');
                }
            });
        },
        createControl: function(n, cm) {
    ...
    tinymce.PluginManager.add('subtitle3', tinymce.plugins.subtitle3);
